...
@property (nonatomic, strong) BalloonView *balloonViewOne;
@property (nonatomic, strong) BalloonView *balloonViewTwo;
@property (nonatomic, strong) BalloonView *balloonViewThree;
